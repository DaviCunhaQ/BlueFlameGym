...
<head>
    ...
    <title>Dale Delivery - Login</title>
</head>
<body>
<style>
        * {
    ...
    <div class="container">
        <div class="title">
            Faça Login
            <a href="login.html">voltar<i class="bi bi-arrow-left-circle-fill"></i></a>
        </div>
        <form action="testLogin_personal.php" method="POST">
            ...
            <div class="button">
                <input type="submit" value="Login personal" name="submit-personal">
            </div>
        </form>
    </div>
</body>
